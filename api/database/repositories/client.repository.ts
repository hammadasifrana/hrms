...
export class ClientRepository {
  constructor(
    private readonly repository: Repository<Client> = AppDataSource.getRepository(Client)
  ) {}
  ...
  async createClient(clientData: Partial<Client>): Promise<Client> {
    ...
    if (existingClient) {
      throw new MoleculerError('Client with this name or domain already exists');
    }
