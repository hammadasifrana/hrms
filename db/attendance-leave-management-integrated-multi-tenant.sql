...
-- Multi-tenant client management integrated into schema

-- Table for clients (tenants)
CREATE TABLE clients (
    client_id UUID PRIMARY KEY DEFAULT uuid(),
